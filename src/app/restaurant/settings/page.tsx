  ...
  async function fetchData() {
    try {
      ...
      if (restaurantData.restaurant) {
        ...
        setName(restaurantData.restaurant.name);
        setDescription(restaurantData.restaurant.description || "");
        setCurrency(restaurantData.restaurant.currency);
      }
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 text-sm mb-4">
              Connectez votre compte Stripe pour recevoir les paiements des
              commandes.
            </p>
